...
import com.kvep.tracker_data.remote.malformedFoodResponse
import com.kvep.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    @Test
    fun `Search food, valid repsonse, return results`()= runBlocking{
    ...
    @Test
    fun `Search food, invalid repsonse, return results`()= runBlocking{
        mockWebServer.enqueue(
            MockResponse()
                .setResponseCode(403)
                .setBody(validFoodResponse)
    ...
    @Test
    fun `Search food, malformed repsonse, return results`()= runBlocking{
        mockWebServer.enqueue(
            MockResponse()
